...
assert 'versionCode = 23' in gradle and 'versionName = "0.6.0-rc7-network-diagnostics"' in gradle, gradle
...
print(f'GHARTV_SOURCE_VALIDATION=PASS · {len(list(java.glob("*.java")))} Java files · 0.6.0 RC7 network / diagnostics review')
PY
