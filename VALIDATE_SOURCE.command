...
assert 'versionCode = 20' in gradle and 'versionName = "0.6.0-rc4-owner-convergence"' in gradle, gradle
...
print(f'GHARTV_SOURCE_VALIDATION=PASS · {len(list(java.glob("*.java")))} Java files · 0.6.0 RC4 owner convergence')
PY
