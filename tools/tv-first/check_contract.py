...
assert "version_code=26" in launcher and "manifest.get('version_code')!=26" in launcher
assert "int(codes[0])==26" in launcher and "int(codes[0])<26" in launcher
...
print('REVIEW_CODE26_AND_CORRECTED_OPENER=PASS')
